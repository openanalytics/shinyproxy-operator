...
class ReplicaSetCreator(private val shinyProxy: ShinyProxy, private val configMap: ConfigMap) {

    private val logger = KotlinLogging.logger {}

    private val replicaSetDefinition: ReplicaSet = ReplicaSetBuilder()
            .withNewMetadata()
    ...
    suspend fun create(kubeClient: KubernetesClient): ReplicaSet {
